...
// 20221004
// はいBC3です。ほぼ一緒なんであんま説明すること無いですが将来の自分が困惑するので
// まとめます
// まず、qabというのが(0,0,1)*sizeでz軸の上の方にあってそこからy軸に平行にすーっといくとqcaである(0,1/sqrt(2),1)*typeとsizeが
// あって一方qabからxz平面内をななめ45°にすーっと高さの半分降りたところにqbcがありますわ。
// で、これらの作る正方形の8分の1の領域が基本領域で鏡映4回で必ずここに落ちますからここでレイマーチングのsdfを適用するってわけです
// で
// このときqbcは面の重心ですからたとえば重心ベクトルがqbcならば面の重心を結びますから正八面体になりますし
// qabなら辺の中点を結びますから小さい立方体ができますし
// qcaなら元の形です。まあそんな感じ。
// 他の点の場合も鏡映で点を移せば大体想像は尽きますし切頂したいなら適当に点を取って想像しましょう

// 応用編

// 星型に行きたいならもっと深い理解が必要になります。あれはまず基本領域で何をすればいいかを割り出すところから始めないといけない。
// それが終わったら、結局その形が一筋縄ではいかず、というのも面が2枚だったりしますから。その法線ベクトルはなんじゃい、って。
// それを割り出す必要があって。それを計算したうえで場合によっては複数の面を組み合わせたりしないといけないんですよ。
// 苦労しました....

// たとえば小星形十二面体あるでしょ、あれは120の部屋のうち2つの部屋を使う、面が60ですから。基本領域は1つの面の
// 片割れになるんですが、その面の法線ベクトルを割り出して、然るべき頂点で面を取ればいいんです。それでできちゃいます。
// 最終的には驚くほど簡単になるのでびっくりしますよ。
