...
// 必要になりそうなので4次方程式の解法かも～ん！
// って思ったけどどうも3次でいい？まあいいや。
...
function solve4(a3, a2, a1, a0){
	...
	let w = getSub(q, r);
	// wは3次方程式4w^3 - 3qw - r = 0の正の解）
	// 3次方程式は必ず0以上の実数解をもつ方程式に変形できる。
	// 0が解の一つならそれは2次方程式に退化するし、正の解をもつなら判別式で場合分けすることで
	// このプログラムのように容易に他の解を導き出せる。
