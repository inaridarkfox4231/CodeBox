...
function startGUI(){
  ...
  objectFolder.add(config, 'textureType', {'NONE':TEXTURE_NONE, 'RANDOM':TEXTURE_RANDOM, 'CHECK':TEXTURE_CHECK, 'CLOUD':TEXTURE_CLOUD}).name('texture');
  ...
  textFolder.add(config, 'fontType', {'REGULAR':FONT_REGULAR, 'HUI':FONT_HUI, 'BEAST':FONT_BEAST, 'HANNARI':FONT_HANNARI}).name('font');
  // フラワー用
